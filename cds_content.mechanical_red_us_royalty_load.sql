...
BEGIN   
  ...
  v_reporting_period := reporting_period_id from cds_content.reporting_period where reporting_period_name = v_q;
  ...
  */ 
  ...
  --CREATING TEMP TABLE, WHICH COLLECTS THE MOVES OUT OF THE BUSINESS MODEL
  ...
  IF v_dim < 3 THEN 
    raise exception 'The rates need to be setup!';
  END IF;
